...
export default async function ConfiguracionPage() {
  ...
  // Administrador+ entra a Configuración. La gestión de usuarios, la estructura
  // y el monitoreo de Supabase quedan solo para quien administra usuarios
  // (superadmin/rector); el Administrador ve únicamente la pestaña de
  // Componentes de Memoria Corporativa.
        ...
        content: (
          <div className="flex flex-col gap-6">
            ...
            <ImportadorExcel
              ...
              plantillaHref="/configuracion/plantilla"
  ...
  // final y solo para quien administra usuarios.
  if (puedeGestionarUsuarios) {
    tabs.push({
      id: "supabase",
